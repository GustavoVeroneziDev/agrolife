    ...
    <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5">
        <div class="card p-4 mt-2">
            <div class="text-center mb-4">
                ...
                <p class="text-secondary small">Cadastre-se para acompanhar a saúde do seu animal</p>
            </div>
            ...
            <form action="<?= BASE ?>/usuario/processa_cadastro.php" method="POST" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nome" name="nome" class="form-control"
                               placeholder="Seu nome" required autocomplete="name" maxlength="100"
                               value="<?= h($_GET['nome'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control"
                               placeholder="seu@email.com" required autocomplete="email" maxlength="150"
                               value="<?= h($_GET['email'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label" for="telefone">
                        WhatsApp <span class="text-secondary">(para lembretes de vacina)</span>
                    </label>
                    <div class="input-group">
